<template>
    <div>
        <!-- Modal -->
        <div class="modal" id="mdlLineas" tabindex="-1" aria-labelledby="mdlLineasLabel" aria-hidden="true" @keydown.esc.prevent="cerrar()">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="mdlLineasLabel">Mantenimiento de Líneas</h6>
							...
							<table class="table table-sm table-dark table-hover table-bordered" style="table-layout: fixed;">
							  	...
							  	<tbody  class="table-group-divider">
							    	<tr v-for="(i, index) in list" :ref="index" :class="n_index == index ? 'table-active' : ''" @click="selLista(index)" @dblclick="editar()">
							      		<td class="text-left" v-text="i.c_line"></td>
							      		<td class="text-left text-truncate" v-text="i.l_line"></td>
							      		<td></td>
							    	</tr>
							  	</tbody>
							</table>
                                    ...
                                    <div class="card-body">
                                        <div class="row g-0">
                                            <div class="col-2 px-1 mb-1">
                                                ...
                                                <div class="">
                                                    <input type="text" class="form-control form-control-sm" :value="f.c_line" disabled/>
                                                </div>
                                            </div>
                                            <div class="col-4 px-1 mb-1">
                                                <label for="" class="col-form-label col-form-label-sm">Descripción:</label>
                                                <div class="">
                                                    <input type="text" class="form-control form-control-sm text-uppercase" v-model="f.l_line" :disabled="disabled" />
                                                </div>
                                            </div>   
                                            <div class="col-3 px-1 mb-1">
                                                <label for="" class="col-form-label col-form-label-sm">Impresora:</label>
                                                <div class="">
                                                    <input type="text" class="form-control form-control-sm text-uppercase" v-model="f.l_impr" :disabled="disabled"/>
                                                </div>
                                            </div>    
                                            <div class="col-3 px-1 mb-1">
...
<script>
    ...
    export default {
        ...
        updated() {
            ...
            this.$store.commit("mutLineas", [])
        },
        mounted() {
            this.currentModal = new coreui.Modal(document.getElementById('mdlLineas'), {
                keyboard: false,
                backdrop: 'static',
            })
        ...
        methods:{
            ...
            selLista(index) {
                ...
                this.f.l_line = value.l_line
                this.f.l_impr = value.l_impr
            ...
            grabar() {
                this.q_load = 1
                axios.post("/lineas/grablineas", {...this.f, k_grab: this.k_grab})
                .then(resul => {
